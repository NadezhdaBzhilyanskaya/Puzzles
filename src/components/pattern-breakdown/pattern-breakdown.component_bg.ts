...
//       //this.img.src = "blockview.png"; // ON IMAGE Change
//       this.img2.src = this.imageName2;

//       console.log(this.context)
//       this.img.onload = (e) => this.loadImage(e);

//       this.img2.onload = (e) => this.loadImage2(e);
//       //, 1000)
//     } catch (e) {
...
//     this.loaded1 = true;
//     if (this.loaded2) this.afterLoadBoth();
...
//     // console.log(e.target.width, e.target.height)
//     this.context2.reset();
//     this.canvas2.height = this.img2.height;
//     this.canvas2.width = this.img2.width;
//     this.context2.drawImage(this.img2, 0, 0, this.img2.width, this.img2.height);
//     //console.log(this.context.createImageData(this.img.width, this.img.height))
//     this.imageData2 = this.context2.getImageData(0, 0, this.img2.width, this.img2.height).data;

//     this.loaded2 = true;
//     if (this.loaded1) this.afterLoadBoth();


//   }

//   public afterLoadBoth() {
//     console.log('loaded');
...
//         if (c.dmc == 'None' || c.str == '#fcfcff' || c.str == '#fffdf9' || c.str == '#efeef0' || c.str == '#fff7e7') c = this.getPixelColor2(x, y);
//         row.push(c);
...
//     // ON SECTION Change
//     //if (this.imageName == 'test.png') this.colors = this.colors.slice(60, 151).map(r => r.slice(60, 171))//, 171))
...
//       }))
//     })
//     console.log(this.colors[0].length, this.colors.length)
...
//     return temp;
//   }
//   private getPixelColor2(x, y): Color {
//     const red = y * (this.img2.width * 4) + x * 4;
//     const temp = {
//       r: this.imageData2[red],
//       g: this.imageData2[red + 1],
//       b: this.imageData2[red + 2],
//       a: this.imageData2[red + 3],
//       str: '',
//       dmc: '',
//       show: true
//     };
